...
function BottomTabBar() {
  return (
    <div className="sticky bottom-0 flex w-full items-center justify-between border-t border-[#e5e7eb] bg-white px-5 pb-4 pt-2">
      <Link to="/home/no-appointment" className="flex flex-col items-center gap-1 px-2 py-1">
      ...
      <div className="flex min-h-svh justify-center bg-gray-200">
        <div className="relative flex w-full max-w-[393px] flex-col bg-[#fffaf5]">
          ...
          <div className="flex flex-1 flex-col gap-[17px] px-3.5 pb-8">
            ...
            {/* no upcoming appointment - CTA */}
            <section className="w-full rounded-[14px] border border-[#e5e7eb] bg-white px-3 py-4 shadow-[0px_2px_4px_rgba(109,109,109,0.1)]">
              <SectionLabel>Upcoming Appointments</SectionLabel>
              <div className="mt-3 flex flex-col items-start gap-6">
                <div className="flex flex-col gap-2">
                  <p className="font-serif text-[16px] italic text-[#464747]">Next Botox visit is due in 3 weeks.</p>
                  <p className="text-[12px] text-[#475569]">Schedule your appointment with Chelsea Leos.</p>
                </div>
                <div className="flex items-center gap-2">
                  <Link
                    to="/book/locations"
                    className="flex items-center justify-center rounded-[6px] bg-[#3995fc] px-4 py-2 text-[14px] font-medium text-white"
                  >
                    Book with Chelsea
                  </Link>
                  <button
                    type="button"
                    className="flex w-[156px] items-center justify-center rounded-[6px] border border-[#3995fc] px-4 py-2 text-[14px] font-medium text-[#3995fc]"
                  >
                    Remind me
                  </button>
                </div>
