...
const CATEGORIES = [
  { name: 'Consults', count: '3 services', to: '/book/select-service/expanded-1' },
  { name: 'Injectables', count: '3 services', to: '/book/select-service/expanded-2' },
  { name: 'Peptides', count: '3 services' },
  { name: 'Skin', count: '3 services' },
]

function CategoryFolder({ name, count, to }) {
  const content = (
  ...
  const className = 'block w-full overflow-hidden rounded-xl border border-[#f8f8f8] bg-white'
